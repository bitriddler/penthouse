...
const launchBrowserIfNeeded = (() => {
  var _ref = _asyncToGenerator(function* (options, debuglog) {
    if (options.puppeteer && typeof options.puppeteer.getBrowser === 'function') {
      browser = yield options.puppeteer.getBrowser();
    }
    if (browser) {
      return;
    }
  ...
  return function launchBrowserIfNeeded(_x, _x2) {
...
const generateCriticalCssWrapped = (() => {
        ...
        try {
          ...
          if (!forceTryRestartBrowser && !(yield browserIsRunning())) {
            ...
            if (_browserLaunchPromise) {
              ...
              browser = null;
              yield launchBrowserIfNeeded(options, debuglog);
            }
            // retry
  ...
  function generateCriticalCssWrapped(_x5, _x6, _x7) {
